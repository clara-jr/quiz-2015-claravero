...
exports.statistics = function(req, res){
  models.Quiz.findAll().then(function(quizes){
    ...
    models.Fav.findAll(options).then(function(favs){
      ...
      models.Comment.findAll().then(function(comments){
        ...
        res.render('quizes/statistics', {quizes: quizes, favoritos: numFavs, preguntas: numPregs, comentarios: numComentariospublis, media: media, sinComments: sinComments, conComments: conComments, errors: []});
